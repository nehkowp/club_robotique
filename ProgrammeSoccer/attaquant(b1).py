...
with rsk.Client(host='192.168.100.1', key='') as client:
        ...
        while True:
            ...
            try:
                ...
                print("Position robot actuel", client.blue1.position)
                print("Position Robot prévue : ", point_on_line(client.ball[0], client.ball[1], 0.9, 0, -0.05))
                coords_prevus = point_on_line(client.ball[0], client.ball[1], 0.9, 0, -0.08)
                target1 = [coords_prevus[0], coords_prevus[1],0]
                client.blue1.goto(target1)
                target2 = [coords_prevus[0], coords_prevus[1],angle_ball(client.blue1.position,client.ball)]
                client.blue1.goto(target2)
                client.blue1.kick()                
            ...
            # #time.sleep(1)
            # client.blue1.goto((0.55, 0.55, 0))
            # client.blue1.goto((-0.55, 0.55, 0))
            # client.blue1.goto((-0.55, -0.55, 0))
            # client.blue1.goto((0.55, -0.55, 0))
            ##print(client.ball[1])
            ##print(client.ball[0])
            ##client.blue1.goto((client.ball[0], client.ball[1], 0))
            ##client.blue1.kick()
